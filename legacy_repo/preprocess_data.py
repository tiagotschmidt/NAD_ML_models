...
normal_abnormal_column = pd.DataFrame(original_data.label.map(lambda x:'normal' if x=='normal' else 'abnormal'))
...
numerical_data = normal_abnormal_data[['count','srv_serror_rate','serror_rate','dst_host_serror_rate','dst_host_srv_serror_rate',
